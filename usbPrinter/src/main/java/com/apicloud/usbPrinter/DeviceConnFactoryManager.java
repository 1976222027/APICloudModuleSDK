...
import static com.apicloud.usbPrinter.DeviceConnFactoryManager.CONN_METHOD.USB;
...
//                    String status = UsbPrinter.getContexts().getString(R.string.str_printer_conn_normal);
                    ...
                    if (sendCommand == esc) {
                        ...
                        if (currentPrinterCommand == null) {
                            ...
                            if (result == 0) {//打印机状态查询
                                ...
                                UsbPrinter.getContexts().sendBroadcast(intent);
                            } else if (result == 1) {//查询打印机实时状态
                                if ((buffer[0] & ESC_STATE_PAPER_ERR) > 0) {
//                                    status += " "+ UsbPrinter.getContexts().getString(R.string.str_printer_out_of_paper);
                                    status += " "+ "打印机缺纸";
                                }
                                if ((buffer[0] & ESC_STATE_COVER_OPEN) > 0) {
//                                    status += " "+ UsbPrinter.getContexts().getString(R.string.str_printer_open_cover);
                                    status += " "+ "打印机开盖";
                                }
                                if ((buffer[0] & ESC_STATE_ERR_OCCURS) > 0) {
//                                    status += " "+ UsbPrinter.getContexts().getString(R.string.str_printer_error);
                                    status += " "+ "打印机出错";
                                }
//                                System.out.println(UsbPrinter.getContexts().getString(R.string.str_state) + status);
//                                String mode= UsbPrinter.getContexts().getString(R.string.str_printer_printmode_esc);
                                String mode= "打印模式:ESC";
                                Utils.toast(UsbPrinter.getContexts(), mode+" "+status);
                            }
                        }
...
//                                System.out.println(UsbPrinter.getContexts().getString(R.string.str_state) + status);
//                                String mode= UsbPrinter.getContexts().getString(R.string.str_printer_printmode_tsc);
...
//                                String mode= UsbPrinter.getContexts().getString(R.string.str_printer_printmode_cpcl);
